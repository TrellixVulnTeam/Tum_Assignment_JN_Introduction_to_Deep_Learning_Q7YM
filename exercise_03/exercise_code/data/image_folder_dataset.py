...
class ImageFolderDataset(Dataset):
    ...
    def make_dataset(directory, class_to_idx):
        ...
        length=[4965,5010,4943,5056,5017,5009,4974,4986,5047,4993]
        j=0
        img = []
        lab=[]
        
        for label,class_id in enumerate(sorted(class_to_idx.keys())):
    ...
    def __len__(self):
        ...
        data,label= ImageFolderDataset.make_dataset(self.root_path,self.class_to_idx)
        length = len(data)
    ...
    def __getitem__(self, index):
        ...
        Im= np.asarray(Image.open(self.images[index]),dtype=float)
...
class RescaleTransform:
    ...
    def __call__(self, images):
        ...
        images=(images/self._data_max)*(self.max-self.min)
