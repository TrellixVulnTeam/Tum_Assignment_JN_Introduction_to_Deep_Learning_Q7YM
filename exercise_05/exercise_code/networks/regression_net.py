...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        out,cache_sigmoid=sigmoid_forward(out1)
        out2,cache_affine2=affine_forward(out,W2,b2)
        #pass
        y=out2
    ...
    def backward(self, dy):
        ...
        dsig=sigmoid_backward(dx2,cache_sigmoid)
        dx1,dW1,db1=affine_backward(dsig,cache_affine1)
